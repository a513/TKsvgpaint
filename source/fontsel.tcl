...
namespace eval szdkfFontSel {
	...
	ttk::scrollbar $w.familyX -command [list $w.family xview]
	ttk::scrollbar $w.familyY -command [list $w.family yview]
...
#        raise $w
	...
	*DKFChooseFont.sample.text.text	       ABCabcXYZxyz12345АБВабвЭЮЯэюя
