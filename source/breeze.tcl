...
set I(scrollbar-trough-vert-active_ME) [image create photo  -data {
...
set I(scrollbar-trough-horiz-active_ME) [image create photo  -data {
...
set I(labelframe_ORIG) [image create photo  -data {
